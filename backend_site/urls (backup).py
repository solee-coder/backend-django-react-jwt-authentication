...
# Registration
    ...
    path('dj-rest-auth/registration/verify-email/<str:key>', verify_email, name="account_confirm_email"),


# Password

    path('password/reset/confirm/<uid>/<str:token>', password_reset_confirm, name="password_reset_confirm"),
